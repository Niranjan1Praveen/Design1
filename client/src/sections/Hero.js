        ...
        <div className="max-w-screen-md mx-auto">
          ...
          <h2 className="text-4xl font-semibold !leading-tight mb-4 md:text-5xl md:mb-5 lg:text-6xl ">
            ...
            <span className="relative isolate ms-4">
              ...
              <span className="absolute -z-10 top-2 -left-6 -right-4 bottom-0.5 bg-foreground/5 rounded-full px-8 ms-3 border-t border-t-foreground/20 shadow-[inset_0px_0px_30px_0px] shadow-foreground/20 md:top-3 md:bottom-1 lg:top-4 lg:bottom-2"></span>
            </span>
          </h2>
          ...
          <div className="flex justify-center gap-2 mt-6 md:mt-10">
            ...
            <Button variant={"ghost"}><PlayCircle/> Watch Demo</Button>
          </div>
        </div>
        <div className="relative mt-12 max-w-screen-xl mx-auto">
          <figure className="bg-background/60 backdrop-blur-3xl rounded-xl shadow-2xl">
            <Image
              src={heroBanner}
              width={1468}
              height={815}
            ...
            <div className="absolute bg-primary inset-0 blur-[200px] scale-y-75 scale-x-125 rounded-full -z-10"></div>
          </figure>
        </div>
      </div>
    </section>
