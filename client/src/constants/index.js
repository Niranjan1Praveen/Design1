  ...
  features: [
    {
      ...
      description:
        "Experience advanced analytics capabilities that enable you to dive deep into data, uncover meaningful patterns, and derive actionable insights",
    },
    {
      Icon: Files,
      ...
      description:
        "Save time and effort with automated reporting, generating comprehensive and accurate reports automatically, streamlining your data analysis",
    },
    {
      Icon: UserRoundPen,
      ...
      background: (
        <img
          src="/retention-bg.png"
          className="absolute -right-20 -top-20 opacity-60"
        />
      ),
      className: "lg:col-start-1 lg:col-end-2 lg:row-start-3 lg:row-end-4",
      description:
        "Enhance retention with our report, maximizing customer engagement and loyalty for business",
    },
    {
      Icon: GitFork,
      ...
      description:
        "Efficiently compare A/B test variants to determine the most effective strategies",
    },
    {
      Icon: Blocks,
      ...
      description:
        "Seamlessly integrate with our directory, maximizing efficiency and unlocking the full potentials",
    },
  ],
};
